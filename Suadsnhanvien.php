<?php
    ...
    or die('Lỗi kết nối');
    $manv=''; $tennv=''; $diachinv=''; $sdtnc=''; $emailnv=''; $chucvu='';
    $manv=$_GET['Manv'];
    ...
    //Xử lí button Lưu
        ...
        $diachinv=$_POST['txtdiachinv'];
        $sdtnv=$_POST['txtsdtnv'];
        $emailnv=$_POST['txtemailnv'];
        $chucvu=$_POST['txtchucvu'];
        if($manv==''|| $tennv==''||$diachinv==''||$sdtnv==''||$emailnv==''|| $chucvu=='')
    {
        echo "<script>alert('Phải nhập đủ dữ liệu')</script>";  
    }
    else{
        if(preg_match('/[a-zA-Z]/', $sdtnv)){
            echo "<script>alert('Số điện thoại phải là những chữ số!!!')</script>";}
        else{
    $sql="UPDATE qlnhanvien SET Tennv='$tennv', Diachinv='$diachinv',Sdtnv='$sdtnv',Emailnv='$emailnv',Chucvu='$chucvu'  WHERE Manv='$manv'";
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h4 class="ttitle">CẬP NHẬT THÔNG TIN NHÂN VIÊN</h4>
                                </td>
                            </tr>
                        </table>
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtmanv' value="<?php echo $row['Manv'] ?>" disabled>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txttennv' value="<?php echo $row['Tennv'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Địa chỉ nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtdiachinv' value="<?php echo $row['Diachinv'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Số điện thoại nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtsdtnv' value="<?php echo $row['Sdtnv'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Email nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtemailnv' value="<?php echo $row['Emailnv'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Chức vụ nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtchucvu' value="<?php echo $row['Chucvu'] ?>">
                                </td>
                            </tr>
                            <?php
                                    }
