...
if(isset($_POST['btnnhaphang'])){
    ...
    $sqltk="SELECT * FROM chitietphieunhap WHERE id like '%$id%' Loaisp like '%$lsp%' and Tensp like '%$tsp%' and Nhasx like '%$nsx%' and Soluong like '%$sl%'and Dongianhap like '%$dgn%'and Dongiaban like '%$dgb%'";
...
if(isset($_POST['btnNhaphang']))
{
    ...
    if($id==''|| $lsp==''||$tsp==''|| $nsx==''|| $sl==''||$dgn==''||$dgb=='')
        ...
        if(mysqli_num_rows($dt)>0)
            ...
            $sql="INSERT INTO chitietphieunhap VALUE('$id','$lsp','$tsp','$nsx','$sl','$dgn','$dgb')";
            ...
            <div class="content">
                <form method="post" action="">
                    <table>
                        <tr>
                            <td>
                                <h5 class="ttitle"> THÊM CHI TIẾT PHIẾU nhập </h5>
                            </td>
                        </tr>
                    </table>
                    <table>
