...
if(isset($_POST['btnnhaphang'])){
    ...
    $sqltk="SELECT * FROM phieunhap WHERE Sophieu like '%$sp%' and Ngaynhap like '%$nn%' and Nhanvien like '%$nv%'";
...
if(isset($_POST['btnNhaphang']))
{
    ...
    if($sp==''|| $nn==''|| $nv=='')
        echo "<script>alert('Phải nhập đầy đủ dữ liệu')</script>";  
        ...
        if(mysqli_num_rows($dt)>0)
            ...
            $sql="INSERT INTO phieunhap VALUE('$id', '$sp','$nn','$nv')";
            ...
            <div class="content">
                <form method="post" action="">
                    <table>
                        <tr>
                            <td>
                                <h5 class="ttitle"> THÊM PHIẾU NHẬP </h5>
                            </td>
                        </tr>
                    </table>
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input type="number" name="txtSophieu">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Ngày nhập</td>
                            <td class="col2">
                                <input type="date" name="dtNgaynhap" >
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Nhân viên</td>
                            <td class="col2">
                                <!-- <input type="text" name="txtNhanvien" > -->
                        ...
                        <tr>
                            <td class="col1"></td>
                            <td class="col2">
                                <input class="btn btn-dark" type="submit"name="btnNhaphang" value="Nhập hàng" >
                                &nbsp; &nbsp;
                            </td>
                        </tr>
                    </table>
