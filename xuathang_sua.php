<?php
    ...
    $sql="UPDATE xuathang SET Noidung2='$nd', Ghichu2='$gc',Ngaytao2='$nt' WHERE Madh='$dh'";
    $kq=mysqli_query($con,$sql);
    if($kq) {
        header("location: Xuathang.php");
        exit;
    }
            ...
            <div class="content">
                <form method="post" action=""> 
                    <table>
                        <tr>
                            <td>
                                <h5 class="ttitle">SỬA THÔNG TIN XUẤT HÀNG</h5>
                            </td>
                        </tr>
                        <table>
                            <?php
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtNoidung' value="<?php echo $row['Noidung2'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Ghi chú</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtGhichu' value="<?php echo $row['Ghichu2'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Ngày tạo</td>
                                <td class="col2">
                                    <input class="form-control" type="date" name='dtNgaytao' value="<?php echo $row['Ngaytao2'] ?>">
                                </td>
                            </tr>
                            <?php
                                    }
