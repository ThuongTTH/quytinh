<?php
    ...
    $id='';$sop='';$nn='';$nv='';
    $id=$_GET['id'];
    $sql1="SELECT * FROM phieunhap WHERE id='$id'";
    $data=mysqli_query($con,$sql1);
    if(isset($_POST['btnluu'])){
        $sp=$_POST['txtSophieu'];
        // $id=$_POST['id'];
        $sop=$_POST['txtSophieu'];
        $nn=$_POST['dtNgaynhap'];
    ...
    $sql="UPDATE phieunhap SET Sophieu = '$sop', Ngaynhap='$nn', Nhanvien='$nv' WHERE id='$id'";
            ...
            <div class="content">
                <form method="post" action=""> 
                    <table>
                        <tr>
                            <td>
                                <h5 class="ttitle">SỬA PHIẾU NHẬP</h5>
                            </td>
                        </tr>
                    </table>
                    <table>
                        ...
                        <tr>
                            <td class="col1">Id</td>
                            <td class="col2">
                                <input class="form-control" type="int" name='id' value="<?php echo $row['id'] ?>" disabled>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Số phiếu</td>
                            <td class="col2">
                                <input class="form-control" type="number" name='txtSophieu' value="<?php echo $row['Sophieu'] ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input class="form-control" type="date" name='dtNgaynhap' value="<?php echo $row['Ngaynhap'] ?>">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Nhân viên</td>
                            <td class="col2">
                                <!-- <input class="form-control" type="text" name='txtNhanvien' value="<?php echo $row['Nhanvien'] ?>"> -->
                                <select name="txtNhanvien">
                                    <?php
                                        ...
                                        $sql = "SELECT Tennv FROM qlnhanvien";
                                        $result = mysqli_query($conn, $sql);

                                        // Kiểm tra và hiển thị các giá trị trong combobox
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                echo "<option value='" . $row['Tennv'] . "'>" . $row['Tennv'] . "</option>";
                                            }
                                        }
                                    ?>
                                </select>
