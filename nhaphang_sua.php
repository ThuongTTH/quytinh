<?php
    ...
    $sql="UPDATE nhaphang SET Noidung1='$nd', Ghichu1='$gc',Ngaytao1='$nt' WHERE Madh='$dh'";
...
<head>
    ...
    <title>Nhập hàng | Quản lý kho hàng</title>
            ...
            <div class="content">
                <form method="post" action=""> 
                    <table>
                        <tr>
                            <td>
                                <h5 class="ttitle">SỬA THÔNG TIN HÀNG</h5>
                            </td>
                            </tr>
                            <table>
                                <?php
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtMadh' value="<?php echo $row['Madh'] ?>" disabled>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtNoidung' value="<?php echo $row['Noidung1'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Ghi chú</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtGhichu' value="<?php echo $row['Ghichu1'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Ngày tạo</td>
                                <td class="col2">
                                    <input class="form-control" type="date" name='dtNgaytao' value="<?php echo $row['Ngaytao1'] ?>">
                                </td>
                            </tr>
                            <?php
                                    }
