<?php
    ...
    $masp='';$tongtiennhap='';$tongtienxuat='';
    ...
    //Xử lí button Lưu
        if(isset($_POST['btnluu'])){
            ...
            if($tongtiennhap>=$tongtienxuat){
                $loinhuan=0;
                $sql="UPDATE ql_thongke_doanhthu SET Tongtiennhap='$tongtiennhap', Tongtienxuat='$tongtienxuat', Loinhuan='$loinhuan' WHERE Masp='$masp'";
                    ...
                    <table>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtdvt' value="<?php echo $row['Dvt']  ?>" disabled>
                                </td>
                            </tr>
                            <tr>
