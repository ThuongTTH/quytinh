...
<head>
    ...
    <title>Home | Quản lý kho hàng</title>
    ...
    <div class="grid">
        <div class="grid__column-1_5">
            <div class="right_menu">
                <div class="right_menu-list">
                    ...
                    <div class="right_menu-item active">
        ...
        <div class="grid__column-10_5">
            <div class="background-img">
                <ul>
                    <li class="title">Nhóm 15</li>
                    <li>Huỳnh Nhật Minh</li>
                    <li>Nguyễn Anh Quân</li>
                    <li>Nguyễn Thanh Huyền</li>
                    <li>Trần Thị Huyền Thương</li>
                    <li>Nguyễn Hữu Đức Anh</li>
                </ul>
            </div>
            <!-- <div class="content">
            </div> -->
