<?php
    ...
    or die('Lỗi kết nối');
    $msp=''; $tsp='';$tenloai='';$nsx='';$nhh='';$dvt='';$gianhap='';
    $giabansi='';$giabanle='';$trangthai='';
    $msp=$_GET['Masp'];
    ...
    //Xử lí button Lưu
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    echo "<script>alert('Giá bán lẻ phải lớn hơn hoặc giá bán sỉ!')</script>";
                }
                else 
                {
                    $chenhlech=$giabanle-$giabansi;
                    $sql="UPDATE qlchitietsp SET Tensp='$tsp', Tenloai='$tenloai', Ngaysx='$nsx', Ngayhh='$nhh', Gianhap='$gianhap',Giabansi='$giabansi', Giabanle='$giabanle',  Trangthai='$trangthai'
                    WHERE Masp='$msp'";
                    ...
                    <table>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txttsp' value="<?php echo $row['Tensp'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên loại</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='tenloai' value="<?php echo $row['Tenloai'] ?>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='dvt' value="<?php echo $row['Dvt'] ?>">
                                </td>
                            </tr>
                            <tr>
