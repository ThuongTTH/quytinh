...
$makh='';$tenkh='';$diachikh='';$sdtkh='';$tensp='';$soluongmua='';$thoigianmua='';
if(isset($_POST['btnthemmoi'])){
    ...
    if($makh==''||$tenkh==''||$diachikh==''||$sdtkh==''||$tensp==''||$soluongmua==''||$thoigianmua=='')
    {
        ...
        if(mysqli_num_rows($dt)>0)
            echo "<script>alert('Khách hàng đã tồn tại')</script>";
        else{
            $sql="INSERT INTO qlkhachhang VALUE('$makh','$tenkh','$diachikh','$sdtkh','$tensp','$soluongmua','$thoigianmua')";
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h4 class="ttitle">THÊM MỚI KHÁCH HÀNG</h4>
                                </td>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name="txtmakh" value="<?php echo $makh ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên khách hàng</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name="txttenkh" value="<?php echo $tenkh ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Địa chỉ khách hàng</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name="txtdiachikh" value="<?php echo $diachikh ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Số điện thoại khách hàng</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name="txtsdtkh" value="<?php echo $sdtkh ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên sản phẩm</td>
                                <td class="col2">
                                    <!-- <input class="form-control" type="text" name="txttensp" value="<?php echo $tensp ?>"> -->
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="number" name="txtsoluongmua" value="<?php echo $soluongmua ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Thời gian mua</td>
                                <td class="col2">
                                    <input class="form-control" type="datetime-local" name="txtthoigianmua" value="<?php echo $thoigianmua ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1"></td>
