                    ...
                    <table>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="number" name="txtsdtkh" value="<?php echo $sdtkh ?>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="date" name="txtthoigianmua" value="<?php echo $thoigianmua ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1"></td>
