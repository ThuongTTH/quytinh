<?php
    ...
    $sql="SELECT*FROM ql_thongke_nhap";
    ...
    if(isset($_POST['btntimkiem']))
    {
        ...
        $sqltk="SELECT * FROM ql_thongke_nhap WHERE Masp like'%$masp%' and Tensp like '%$tensp%'";
        ...
        <div class="grid__column-10_5">
            <div class="content">
                <form method="post" action="">
                    <table>
                        <tr>
                            <td rowspan="2" class="ttitle">
                                <h4 class="ttitle">DANH SÁCH THỐNG KÊ NHẬP</h4>
                            </td>
                        </tr>
                    <table >
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="col2">   
                                ...
                                &nbsp;&nbsp;
                                <a href="./Capnhattknhapxuat.php" class="btn btn-dark" style="color: #fff; text-decoration: none; padding: 4px 13px; position: relative; top: -4px; left: 424px;">Thêm mới</a>
                            </td>
                        </tr>
                    </table>
                        ...
                        <?php
                            ...
                            ?>
                                <tr class="bbody">
                                    ...
                                    <td>
                                        <a href="./Suatknhapxuat.php?Masp=<?php echo $row['Masp'] ?>" style="color: #000">Sửa</a> &nbsp;&nbsp;
                                        <a href="./Xoatknhapxuat.php?Masp=<?php echo $row['Masp'] ?>" style="color: #000">Xóa</a> &nbsp;&nbsp;
                                    </td>
                                </tr>
                            <?php        
                                }
