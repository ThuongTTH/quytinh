...
if(isset($_POST['btnnhaphang'])){
    ...
    $gc=$_POST['txtGhichu'];
    $nt=$_POST['dtNgaytao'];
    $sqltk="SELECT * FROM nhaphang WHERE Madh like '%$dh%' and Noidung1 like '%$nd%' and Ghichu1 like '%$gc%' and Ngaytao1 like '%$nt%'";
...
if(isset($_POST['btnNhaphang']))
{
    ...
    if($dh==''|| $nd==''|| $gc==''|| $nt=='')
        ...
        if(mysqli_num_rows($dt)>0)
            ...
            if($kq) {
                echo "<script>alert('Tao don hang moi thanh cong!')</script>";
            ...
            <div class="content">
                <form method="post" action="">
                    <table>
                        <tr>
                            <td>
                                <h5 class="ttitle"> TẠO ĐƠN HÀNG MỚI </h5>
                            </td>
                        </tr>
                        <tr>
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input type="date" name="dtNgaytao" >
                                </td>
                            </tr>
                            <tr>
                                <td class="col1"></td>
