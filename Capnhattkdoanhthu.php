<?php
    ...
    $masp='';$tensp='';$dvt='';$tongtiennhap='';$tongtienxuat='';
        if(isset($_POST['btnluu'])){
            ...
            if($masp==''||$tensp==''||$dvt==''||$tongtiennhap==''||$tongtienxuat==''){
            ...
            if($tongtiennhap>=$tongtienxuat)
            {
                ...
                $sql2="SELECT * FROM khohang WHERE Tensp='$tensp'";
            ...
            $sql="INSERT INTO ql_thongke_doanhthu VALUES('$masp','$tensp','$dvt','$tongtiennhap','$tongtienxuat','$loinhuan')";
                ...
                <form method="post" action=""> 
                    <table>
                        <tr>
                            ...
                            <h5 class="ttitle">CẬP NHẬT THỐNG KÊ DOANH THU</h5>
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Mã sản phẩm</td>
                            <td class="col2">
                                <!-- <input class="form-control" type="text" name='txtmasp' value="<?php echo $masp ?>"> -->
                                <select name="txtmasp">
                                    <?php
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input class="form-control" type="number" name='txttongtiennhap' value="<?php echo $tongtiennhap ?>">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Tổng tiền xuất(đ)</td>
                            <td class="col2">
                                <input class="form-control" type="number" name='txttongtienxuat' value="<?php echo $tongtienxuat ?>">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1"></td>
