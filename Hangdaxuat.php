<?php
    ...
    {
        $dh=$_POST['txttimkiem'];
        $sqltk="SELECT * FROM xuathang WHERE Madh like'%$dh%' ";
...
if(isset($_POST['btnXuathang']))
{
    ...
    if($dh=='')
        ...
        if(mysqli_num_rows($dt)>0)
            ...
            $sql="INSERT INTO xuathang VALUE('$dh','$nd','$gc','$nt')";
...
<head>
    ...
    <title>Hàng đã xuất | Quản lý kho hàng</title>
            ...
            <table >
                    ...
                    <div class="search-add-filter">
                            <div class="area-search">
                                ...
                                <button name="btnxuatexcel" type="submit"class="fas fa-arrow-right-from-bracket" style="padding: 10px; font-size: 16px; background-color: gray; color: white;"  >
                ...
                <?php
                    ...
                    ?>
                        <tr style="text-align:center" >
                            ...
                            <td>
                            <a  href="./xuathang_sua.php?Madh=<?php echo $row['Madh']?>"><font color="red">Sửa</a> &nbsp;&nbsp;
                                <a href="./xuathang_xoa.php?Madh=<?php echo $row['Madh']?>"><font color="red">Xoá</a>
