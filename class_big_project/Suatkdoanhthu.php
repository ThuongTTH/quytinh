<?php
    ...
    $masp='';$tensp='';$dvt='';$tongtiennhap='';$tongtienxuat='';

    $masp=$_GET['Masp'];
    $sql1="SELECT * FROM ql_thongke_doanhthu WHERE Masp='$masp'";
    ...
    //Xử lí button Lưu
        if(isset($_POST['btnluu'])){
            ...
            $dvt=$_POST['txtdvt'];
            $tongtiennhap=$_POST['txttongtiennhap'];
            $tongtienxuat=$_POST['txttongtienxuat'];
            if($tensp==''||$dvt==''||$tongtiennhap==''||$tongtienxuat==''){
                echo "<script>alert('Phải nhập đủ dữ liệu!')</script>";
            }
            else
            {
            if($tongtiennhap>=$tongtienxuat){
                $loinhuan=0;
                $sql="UPDATE ql_thongke_doanhthu SET Tensp='$tensp', Dvt='$dvt', Tongtiennhap='$tongtiennhap', Tongtienxuat='$tongtienxuat', Loinhuan='$loinhuan' WHERE Masp='$masp'";
                    $kq=mysqli_query($con,$sql);
                    if($kq) {
                        header("location: TKdoanhthu.php");
                        exit;
                    }
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h4 class="ttitle">SỬA THỐNG KÊ DOANH THU</h4>
                                </td>
                            </tr>
                        </table>
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtmasp' value="<?php echo $row['Masp'] ?>" disabled>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtdvt' value="<?php echo $row['Dvt']  ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tổng tiền nhập(đ)</td>
                                <td class="col2">
                                    <input class="form-control" type="number" name='txttongtiennhap' value="<?php echo $row['Tongtiennhap']  ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tổng tiền xuất(đ)</td>
                                <td class="col2">
                                    <input class="form-control" type="number" name='txttongtienxuat' value="<?php echo $row['Tongtienxuat']  ?>">
                                </td>
                            </tr>
                            <?php
                                    }
