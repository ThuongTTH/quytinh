<?php
    ...
    //Xử lí button Lưu
        if(isset($_POST['btnluu'])){
            ...
            if($tensp==''||$dvt==''||$soluongnhap==''){
                echo "<script>alert('Phải nhập đủ dữ liệu!')</script>";
            }
            else{
                $sql="UPDATE ql_thongke_nhap SET Tensp='$tensp', Dvt='$dvt', Soluongnhap='$soluongnhap' WHERE Masp='$masp'";
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h4 class="ttitle">SỬA THỐNG KÊ NHẬP</h4>
                                </td>
                            </tr>
                        </table>
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="number" name='txtsoluongnhap' value="<?php echo $row['Soluongnhap']  ?>">
                                </td>
                            </tr>
                            <?php
                                    }
