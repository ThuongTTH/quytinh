                    ...
                    <table>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="number" name='txtsdtkh' value="<?php echo $row['Sdtkh']  ?>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtthoigianmua' value="<?php echo $row['Thoigianmua']  ?>" >
                                </td>
                            </tr>
                            <?php
                                    }
