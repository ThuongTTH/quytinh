<?php
    ...
    $makh='';$tenkh='';$diachikh='';$stdkh='';$tensp='';$soluongmua='';$thoigianmua='';
    ...
    //Xử lí button Lưu
        if(isset($_POST['btnluu'])){
            ...
            $thoigianmua=$_POST['txtthoigianmua'];
            if($makh==''||$tenkh==''||$diachikh==''||$sdtkh==''||$tensp==''||$soluongmua==''||$thoigianmua==''){
                echo "<script>alert('Phải nhập đủ dữ liệu!')</script>";
            }
            else{
                if(preg_match('/[a-zA-Z]/', $sdtkh)){
                    echo "<script>alert('Số điện thoại phải là những chữ số!!!')</script>";}
                else{
            $sql="UPDATE qlkhachhang SET Tenkh='$tenkh', Diachikh='$diachikh', Sdtkh='$sdtkh', Tensp='$tensp', Soluongmua='$soluongmua', Thoigianmua='$thoigianmua' WHERE Makh='$makh'";
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h5 class="ttitle">SỬA DANH SÁCH KHÁCH HÀNG</h5>
                                </td>
                            </tr>
                        </table>
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtmakh' value="<?php echo $row['Makh'] ?>" disabled>
                                </td>
                            </tr>         
                            <tr>
                                <td class="col1">Tên khách hàng</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txttenkh' value="<?php echo $row['Tenkh'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Địa chỉ khách hàng</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtdiachikh' value="<?php echo $row['Diachikh'] ?>"> 
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Số điện thoại khách hàng</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtsdtkh' value="<?php echo $row['Sdtkh']  ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Số lượng mua</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtsoluongmua' value="<?php echo $row['Soluongmua']  ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Thời gian mua</td>
                                <td class="col2">
                                    <input class="form-control" type="datetime-local" name='txtthoigianmua' value="<?php echo $row['Thoigianmua']  ?>" >
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên sản phẩm</td>
                                <td class="col2">
                                    <!-- <input class="form-control" type="text" name='txttensp' value="<?php echo $row['Tensp']  ?>"> -->
