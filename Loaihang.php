...
if(isset($_POST['btntimkiem']))
{
    ...
    $sqltk="SELECT * FROM qlloaihang
    WHERE Maloai like'%$malh%' and Tenloai like '%$tenlh%'and Nhacc like '%$nhacc%'";
...
<head>
    ...
    <title>Loại hàng | Quản lý kho hàng</title>
            ...
            <div class="content">
                <form method="post" action=""> 
                    <table>
                        <tr>
                            <td> 
                                <h4 class="ttitle">DANH SÁCH LOẠI HÀNG</h4>
                            </td>
                        </tr>
                    </table>
                    <table>
                        <tr>
                            <td class="col1">Mã loại hàng</td>
                            <td class="col2">   
                                <input class="form-control" type="text" name="txtmalh">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Tên loại hàng</td>
                            <td class="col2">   
                                <input class="form-control" type="text" name="txttenlh">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1">Tên nhà cung cấp</td>
                            <td class="col2">   
                                <input class="form-control" type="text" name="txtnhacc">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1"></td>
                            <td class="col2">
                                ...
                                <a class="btn btn-dark" href="./Themmoiloaihang.php" style="color: #fff; text-decoration: none; padding: 4px 13px; position: relative; top: -4px; left: 424px;">Thêm mới</a>
                            </td>
                        </tr>
                    </table>
                            ...
                            while($row=mysqli_fetch_array($data))
                            {
                                ?>
                                    <tr class="bbody">
                                        ...
                                        <td >
                                            <a href="./Dslh_sua.php?Maloai=<?php echo $row['Maloai']?>" style="color: #000;">Sửa</a>  &nbsp;&nbsp;
                                            <a href="./Dslh_xoa.php?Maloai=<?php echo $row['Maloai']?>" style="color: #000;">Xoá</a>
                                        </td>
                                    </tr>
                                <?php
                            }
