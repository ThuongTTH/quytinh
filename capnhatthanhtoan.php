<?php
    ...
    { 
        ...
        $sl=$_POST['txtSoluong'];
        $dg=$_POST['txtDongia'];
        if($makh==''||$tenkh==''||$dc==''||$sdt==''||$tensp==''||$sl==''||$dg==''){
            ...
            <div class="content">
                <form action="" method="post">
                    <table>
                        <tr>
                            <td colspan="2">
                                <h4 class="ttitle">Cập nhật danh sách hóa đơn</h4>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="col2">
                                ...
                                <select name="txtMakh">
                                    <?php
                                        ...
                                        $sql = "SELECT Makh FROM qlkhachhang";
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                ...
                                <select name="txtTenkh">
                                    <?php
                                        $conn = mysqli_connect("localhost", "root", "", "baitaplon");

                                        // Truy vấn cơ sở dữ liệu để lấy các giá trị từ thuộc tính "makh" trong bảng "sanpham"
                                        $sql = "SELECT Tenkh FROM qlkhachhang";
                                        $result = mysqli_query($conn, $sql);
                        ...
                        <tr>
                            ...
                            <td class="col2">
                                <input class="form-control" type="text" name="txtSdt">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="col1">Đơn giá</td>
                            <td class="col2">
                                <input class="form-control" type="number" name="txtDongia">
                            </td>
                        </tr>
                        <tr>
                            <td class="col1"></td>
