...
// xu ly button luu
$manv=''; $tennv='';$diachinv='';$sdtnv='';$emailnv=''; $chucvu='';
if(isset($_POST['btnthemmoi']))
{
    ...
    $sql="SELECT * FROM qlnhanvien WHERE Manv='$manv'";
        ...
        //Tạo truy vấn chèn dữ liệu vào bảng Loại sách
    $sql="INSERT INTO qlnhanvien VALUES('$manv','$tennv','$diachinv','$sdtnv','$emailnv','$chucvu')";
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h4 class="ttitle">THÊM MỚI NHÂN VIÊN<h4>
                                </td>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtmanv' value="<?php echo $manv ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txttennv' value="<?php echo $tennv ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Địa chỉ nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtdiachinv' value="<?php echo $diachinv ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Số điện thoại nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtsdtnv' value="<?php echo $sdtnv ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Email nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtemailnv' value="<?php echo $emailnv ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Chức vụ nhân viên</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtchucvu' value="<?php echo $chucvu ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1"></td>
