...
include_once'./Classes/PHPExcel/IOFactory.php';
    ...
    if(isset($_POST['btntimkiem']))
    {
        $lsp=$_POST['txtLoaisp'];
        $tsp=$_POST['txtTensp'];
        $sqltk="SELECT * FROM chitietphieuxuat WHERE Loaisp like'%$lsp%' and Tensp like '%$tsp%'";
...
if(isset($_POST['btnPhieunhap']))
{
    ...
    if($lsp==''|| $tsp==''|| $nsx==''||$sl==''||$dgn==''||$dgb=='')
        ...
        $sql1="SELECT * FROM chitietphieuxuat WHERE loaisp='$lsp'";
        ...
        if(mysqli_num_rows($dt)>0)
            ...
            $sql="INSERT INTO chitietphieuxuat VALUE('$lsp','$tsp','$nsx','$sl','$dgn','$dgb')";
...
if(isset($_POST['btnxuatexcel']))
{
    ...
    $sheet->setCellValue('D1', 'CHI TIẾT PHIẾU XUẤT');
...
if(isset($_POST['btnUpload']))
{
    ...
    for($i=2;$i<=count($sheetData);$i++){
        ...
        $sql111="INSERT INTO chitietphieuxuat VALUES('$id','$lsp','$tsp','$nsx','$sl','$dgn','$dgb')";
        $con->query($sql111);
    }
    ...
    <div class="grid">
        ...
        <div class="grid__column-10_5">
            <div class="content">
                ...
                <table>
                    <tr>
                        <td class="ttitle">CHI TIẾT PHIẾU xuất</td>
                    </tr>
                </table>
                <table >
                    <tr>
                    ...
                    <td class="col1" >
                        ...
                        <td class="col2">   
                            ...
                            <a href="./cnchitietphieuxuat.php" class="btn btn-dark" style="color: #fff; text-decoration: none; padding: 4px 13px; position: relative; top: -4px; left: 432px;">Thêm mới</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <?php
                        ...
                        ?>
                            <tr class="bbody">
                                ...
                                <td>
                                    <a style="color: #000;" href="./chitietphieuxuat_sua.php?id=<?php echo $row['id']?>">Sửa</a> &nbsp;&nbsp;
                                    <a style="color: #000;" href="./chitietphieuxuat_xoa.php?id=<?php echo $row['id']?>">Xoá</a>
                                </td>
                            </tr>
                        <?php        
                            }
