<?php
    ...
    $sql="UPDATE khohang SET Makhohang='$idkh',Tonkho='$tk' WHERE Masp='$msp'";
            ...
            <div class="content">
                <form method="post" action=""> 
                    <table>
                        <tr>
                            <td>
                                <h5 class="ttitle">SỬA THÔNG TIN KHO HÀNG</h5>
                            </td>
                        </tr>
                        <table>
                            <?php
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtidkhohang' value="<?php echo $row['Makhohang'] ?>">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="number" name='txttk' value="<?php echo $row['Tonkho'] ?>">
                                </td>
                            </tr>
                            <?php
                                    }
