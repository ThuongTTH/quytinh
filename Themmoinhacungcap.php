...
$sql="SELECT*FROM qlnhacc";
$data=mysqli_query($con,$sql);
// xu ly button luu
$mancc=''; $tncc='';$emailncc='';$sdtncc='';
if(isset($_POST['btnthemmoi']))
{
    ...
    if($mancc==''||$tncc==''||$emailncc==''||$sdtncc=='')
    {
        ...
        if(mysqli_num_rows($dt)>0)
            ...
            $sql="INSERT INTO qlnhacc VALUE('$mancc','$tncc','$emailncc','$sdtncc')";
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h4 class="ttitle">THÊM MỚI NHÀ CUNG CẤP</h4>
                                </td>
                            </tr>
                        </table>
                        <table>
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name="txtmancc">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên nhà cung cấp</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name="txttncc">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Email </td>
                                <td class="col2">
                                    <input class="form-control" type="text" name="txtemailncc">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Số điện thoại</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name="sdtncc">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1"></td>
