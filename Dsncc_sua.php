<?php
    ...
    or die('Lỗi kết nối');
    $mancc=''; $tenncc='';$emailncc='';$sdtncc='';
    $mancc=$_GET['Mancc'];
    $sql1="SELECT * FROM qlnhacc WHERE Mancc='$mancc'";
    ...
    //Xử lí button Lưu
        ...
        if($tenncc==''||$emailncc==''||$sdtncc=='')
        {
            echo "<script>alert('Phải nhập đủ thông tin')</script>";
        }
        else{
            if(preg_match('/[a-zA-Z]/', $sdtncc)){
                echo "<script>alert('Số điện thoại phải là những chữ số!!!')</script>";}
            else{
    $sql="UPDATE qlnhacc SET Tenncc='$tenncc', Emailncc='$emailncc', Sdtncc='$sdtncc' WHERE Mancc='$mancc'";
...
<head>
    ...
    <title>Nhà cung cấp | Quản lý kho hàng</title>
                ...
                <form method="post" action=""> 
                    <table>
                        <table>
                            <tr>
                                <td>
                                    <h4 class="ttitle">CẬP NHẬT NHÀ CUNG CẤP</h4>
                                </td>
                            </tr>
                        </table>
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtmancc' value="<?php echo $row['Mancc'] ?>" disabled>
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Tên nhà cung cấp</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txttenncc' value="<?php echo $row['Tenncc'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Email</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtemailncc' value="<?php echo $row['Emailncc'] ?>">
                                </td>
                            </tr>
                            <tr>
                                <td class="col1">Số điện thoại</td>
                                <td class="col2">
                                    <input class="form-control" type="text" name='txtsdtncc' value="<?php echo $row['Sdtncc'] ?>">
                                </td>
                            </tr>
                            <?php
                                    }
