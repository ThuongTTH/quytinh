<?php
    ...
    if(isset($_POST['btntimkiem']))
    {
        $msp=$_POST['txtMasp'];
        $tsp=$_POST['txtTensp'];
        $sqltk="SELECT * FROM khohang WHERE Masp like'%$msp%' and Tensp like '%$tsp%'";
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="col2">   
                                        ...
                                        <a class="btn btn-dark" href="./capnhatkhohang.php" style="color: #fff; text-decoration: none; padding: 4px 13px; position: relative; top: -4.5px; left: 432px;">Thêm mới</a>
                                    </td>
                                </tr>
                            </table>
                        </tr>
